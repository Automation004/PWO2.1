...
public class ImpactAssessmentPom extends CommonData {
	private ExtentTest test;
	public Properties pro;
	public String workOrderIdText;

	public ImpactAssessmentPom(WebDriver driver, ExtentTest _test, Properties _pro) {
	...
	@FindBy(xpath = "//div[contains(text(),'Impact Assessment')]")
	WebElement impactAssessmentClick;
	...
	public void impactAssessmentActions() {
		test.log(Status.INFO, "Clicking on the 'Impact Assessment");
		impactAssessmentClick.click();
